module github.com/yactmz/openbao/api
...
require (
	...
	github.com/yactmz/openbao/api v0.0.0-20240806110544-98b036718b5b
...
replace  github.com/hashicorp/vault/api => github.com/yactmz/openbao/api v0
